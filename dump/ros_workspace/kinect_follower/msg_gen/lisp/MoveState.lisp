...
(cl:in-package kinect_follower-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <MoveState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kinect_follower-msg:<MoveState> is deprecated: use kinect_follower-msg:MoveState instead.")))

(cl:ensure-generic-function 'moving-val :lambda-list '(m))
(cl:defmethod moving-val ((m <MoveState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kinect_follower-msg:moving-val is deprecated.  Use kinect_follower-msg:moving instead.")
  (moving m))
